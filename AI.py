...
start = input("\nYour starting place is: ")
print("Where is your destination? ")
print(", ".join(graph.keys()))
goal = input("Your destination is: ")

if start not in graph or goal not in graph:
    print("Error: One or both locations are not valid!")
    exit()

# Call all algorithms and store results
...
print("UCS Path:", ucs_path if ucs_path else "No path found")
print("IDDFS Path:", iddfs_path if iddfs_path else "No path found")